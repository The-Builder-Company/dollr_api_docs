...
keywords: ["Node.js", "JavaScript", "Dollr integration", "collect payment", "invoice API"]
icon: "node-js"
---
...
<CardGroup cols={2}>
  <Card title="Full Quick Start" icon="rocket" href="/quickstart">
    Same flow with cURL and Python side by side.
  </Card>
  <Card title="Direct checkout" icon="cart-shopping" href="/guides/collect-via-checkout">
    Skip party/invoice steps with one checkout call.
  </Card>
</CardGroup>
