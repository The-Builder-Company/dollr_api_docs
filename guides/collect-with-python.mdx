...
keywords: ["Python", "requests", "Dollr integration", "collect payment", "invoice API"]
icon: "python"
---
...
<CardGroup cols={2}>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Full tutorial with all code samples.
  </Card>
  <Card title="Collect via checkout" icon="cart-shopping" href="/guides/collect-via-checkout">
    One-call checkout source creation.
  </Card>
</CardGroup>
